...
func RegisterHttpHandler(router *mux.Router, endpoints Endpoints, tracer stdopentracing.Tracer, logger log.Logger) {
	...
	router.Methods("POST").Path("/tnr/v1/cats").Handler(
		httptransport.NewServer(
			endpoints.CreateCatEndpoint,
			DecodeHTTPCreateCatZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("create_cat")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "create_cat", logger)))...,
		))

	router.Methods("PUT").Path("/tnr/v1/cats/{cat_id}").Handler(
		httptransport.NewServer(
			endpoints.UpdateCatEndpoint,
			DecodeHTTPUpdateCatZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("update_cat")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "update_cat", logger)))...,
		))

	router.Methods("GET").Path("/tnr/v1/cats/{id}").Handler(
		httptransport.NewServer(
			endpoints.GetCatEndpoint,
			DecodeHTTPGetCatZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("get_cat")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "get_cat", logger)))...,
		))

	router.Methods("GET").Path("/tnr/v1/cats").Handler(
		httptransport.NewServer(
			endpoints.ListCatsEndpoint,
			DecodeHTTPListCatsZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("list_cats")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "list_cats", logger)))...,
		))

	router.Methods("GET").Path("/tnr/v1/cats:batch-get").Handler(
		httptransport.NewServer(
			endpoints.BatchGetCatEndpoint,
			DecodeHTTPBatchGetCatZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("batch_get_cat")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "batch_get_cat", logger)))...,
		))

	router.Methods("DELETE").Path("/tnr/v1/cats/{id}").Handler(
		httptransport.NewServer(
			endpoints.DeleteCatEndpoint,
			DecodeHTTPDeleteCatZeroRequest,
			EncodeHTTPGenericResponse,
			addTracerOption("delete_cat")...,
		// append(serverOptions, httptransport.ServerBefore(opentracing.HTTPToContext(tracer, "delete_cat", logger)))...,
		))
}
...
// DecodeHTTPCreateCatZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded create_cat request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPCreateCatZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.CreateCatRequest
	...
	if len(buf) > 0 {
		req.Cat = &cat.Cat{}
		if err = jsoniter.ConfigFastest.Unmarshal(buf, req.Cat); err != nil {
			const size = 8196
			if len(buf) > size {
				buf = buf[:size]
			}
	...
	err = mjhttp.UnmarshalQueryParam(queryParams, req.Cat, "cat")
	if err != nil {
		if core.IsNotFoundError(err) {
			...
			return nil, nhttp.WrapError(err, 400, "cannot unmarshal the cat  query parameter")
		}
	}
...
// DecodeHTTPUpdateCatZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded update_cat request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPUpdateCatZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.UpdateCatRequest
	...
	err = mjhttp.UnmarshalPathParam(pathParams, &req.Cat.Id, "id", "cat_id")
	if err != nil && !core.IsNotFoundError(err) {
		return nil, nhttp.WrapError(err, 400, "cannot unmarshal the id or cat_id query parameter")
	}

	return &req, nil
}

// DecodeHTTPGetCatZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded get_cat request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPGetCatZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.GetCatRequest
...
// DecodeHTTPListCatsZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded list_cats request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPListCatsZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.ListCatsRequest
...
// DecodeHTTPBatchGetCatZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded batch_get_cat request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPBatchGetCatZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.BatchGetCatRequest
...
// DecodeHTTPDeleteCatZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded delete_cat request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPDeleteCatZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req pb.DeleteCatRequest
